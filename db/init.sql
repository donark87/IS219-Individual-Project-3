...
CREATE TABLE IF NOT EXISTS tblOscar_age_male (
                                                 `Index` INT,
                                                 `Year` INT,
                                                 `Age` INT,
...
INSERT INTO tblOscar_age_male VALUES
...
(76, 2002, 47,' "Adrien Brody"',' "The Pianist"	',NULL),
(77, 2002, 47,' "Sean Penn"',' "Mystic River"	',NULL),
(78, 2002, 47,' "Jamie Foxx"',' "Ray"	',NULL),
(79, 2002, 47,' "Philip Seymour Hoffman"',' "Capote"	',NULL),
(80, 2002, 47,' "Forest Whitaker"',' "The Last King of Scotland"	',NULL),
(81, 2002, 47,' "Daniel Day-Lewis"',' "There Will Be Blood"	',NULL),
(82, 2002, 47,' "Sean Penn"',' "Milk"	',NULL),
(83, 2002, 47,' "Jeff Bridges"',' "Crazy Heart"	',NULL),
(84, 2002, 47,' "Colin Firth"',' "The Kings Speech"	',NULL);